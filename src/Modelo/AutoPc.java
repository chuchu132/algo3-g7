...
public class AutoPc extends Auto{
	...
	public AutoPc (){
		...
		super ( new Motor(200,6,0.2,1000,400,10000),new CajaAutomatica(3,200,80,10000) , new SistemaCombustion(5,100,"Comun",0.01,10000), new Carroceria(300,700,"Ferrari F430",1,0.1,10000)
